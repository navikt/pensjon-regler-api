...
public class ForstevirkFraUforeperiodeUtilTest {
	...
	/**
	 * Tester at persongrunnlag for EPS i SisteAldersberegning2011's får satt førstevirk (PREG intern variabel). 
	 */
	@Test
...
//		assertEquals( date("1-jan-1990"), eps.getPREG_forsteVirk() );
	...
	/**
	 * Tester at persongrunnlag for Avdød i SisteAldersberegning2011's får satt førstevirk (PREG intern variabel).
	 *  
	 */
	@Test
