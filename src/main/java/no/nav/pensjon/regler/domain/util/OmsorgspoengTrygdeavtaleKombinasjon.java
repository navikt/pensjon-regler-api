...
import no.nav.pensjon.regler.domain.util.OmsorgspoengCompareUtil.StorrelseOgLeksikografiskArstallComparator;
...
import static no.nav.pensjon.regler.domain.util.OmsorgspoengCompareUtil.OriginaltOmfangComparator;
import static no.nav.pensjon.regler.domain.util.OmsorgspoengCompareUtil.UtvidetOmfangComparator;
