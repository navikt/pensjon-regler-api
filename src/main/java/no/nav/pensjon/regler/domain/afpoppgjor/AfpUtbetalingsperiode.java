...
public class AfpUtbetalingsperiode implements Comparable<AfpUtbetalingsperiode>, Serializable {
	...
	*/
    ...
    public AfpUtbetalingsperiode(Date virkFom, Date virkTom, int fullAFP, int utbetaltAFP, int fpi, double tpi_faktor, int afpPensjonsgrad, no.nav.pensjon.regler.domain.grunnlag.AfpTpoUpGrunnlag AfpTpoUpGrunnlag, boolean AfpTpoUpGrunnlagAnvendt) {
        super();
