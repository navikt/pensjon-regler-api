...
import no.nav.pensjon.regler.domain.vedtak.FortsattMedlemskap;
import no.nav.pensjon.regler.domain.vedtak.ForutgaendeMedlemskap;
import no.nav.pensjon.regler.domain.vedtak.MedlemskapForUTEtterTrygdeavtaler;
import no.nav.pensjon.regler.domain.vedtak.RettTilEksportEtterTrygdeavtaler;
