...
import static no.nav.domain.pensjon.regler.util.OmsorgspoengLogUtil.printOmsorgsopptjeningListe;
import static no.nav.domain.pensjon.regler.util.OmsorgspoengLogUtil.printRekke;
