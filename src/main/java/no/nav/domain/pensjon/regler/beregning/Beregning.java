...
import no.nav.domain.pensjon.regler.kode.*;
...
public class Beregning implements IBeregning, Serializable {
    ...
    public no.nav.domain.pensjon.regler.beregning.Familietillegg getFamilietillegg() {
        return familietillegg;
    }

    public void setFamilietillegg(no.nav.domain.pensjon.regler.beregning.Familietillegg familietillegg) {
        this.familietillegg = familietillegg;
    }

    public no.nav.domain.pensjon.regler.beregning.FasteUtgifterTillegg getTilleggFasteUtgifter() {
        return tilleggFasteUtgifter;
    }

    public void setTilleggFasteUtgifter(no.nav.domain.pensjon.regler.beregning.FasteUtgifterTillegg tilleggFasteUtgifter) {
        this.tilleggFasteUtgifter = tilleggFasteUtgifter;
    }
